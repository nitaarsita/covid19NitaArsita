...
import com.nitaarsita.covid_19nitaarsita.view.CountryViewModel;
...
public class fragment_country extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_fragment_country, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        CountryViewModel viewModel = new ViewModelProvider(requireActivity(),getDefaultViewModelProviderFactory()).get(CountryViewModel.class);
