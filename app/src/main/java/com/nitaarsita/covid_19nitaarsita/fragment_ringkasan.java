...
import com.nitaarsita.covid_19nitaarsita.view.RingkasanViewModel;
 ...
 */
public class fragment_ringkasan extends Fragment {

    private ProgressDialog mProgressApp;

    public fragment_ringkasan() {
        // Required empty public constructor
    }

    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_fragment_ringkasan, container, false);
    }
